...
public class iframeTest {
    ...
    public void test1() throws InterruptedException {
        ...
        //2.switching with index
         driver.switchTo().frame(0); // ana html icerisinde bir tane baby html/iframe oldugu icin
        //index numrasi sifirdan baslar.

        //clear inside the text
        driver.findElement(By.cssSelector("#tinymce")).clear();

        Thread.sleep(2000);
        driver.findElement(By.cssSelector("#tinymce")).sendKeys("mikesmithwith index");
