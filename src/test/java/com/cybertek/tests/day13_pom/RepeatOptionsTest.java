...
import com.cybertek.pages_PAGEOBJECTMODEL.CalendarEventsPage;
import com.cybertek.pages_PAGEOBJECTMODEL.CreateCalendarEventsPage;
import com.cybertek.pages_PAGEOBJECTMODEL.LoginPage;
...
public class RepeatOptionsTest extends TestBase {
    ...
    * */
    ...
    public void test1(){
        ...
        Assert.assertTrue(createCalendarEventsPage.days.isSelected(), "verify repeat day is seleted");
